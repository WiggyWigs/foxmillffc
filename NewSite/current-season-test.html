  ...
  <div class="panel">
    ...
    <div id="honorable-mention-wrap" class="recap-tight-wrap" style="display:none;">
      ...
      <div class="box-score-card honorable-mention-card" id="honorable-mention-card">
        ...
        <span class="hm-click-hint">Click for Recap</span>
      </div>
    </div>
    ...
    <div class="record-section" id="callouts-section" style="display:none;">
      <hr class="section-divider recap-tight-divider">
      <h3 class="season-subhead tgl-heading">This Week's Notes</h3>
      <hr class="recap-thin-divider">
      <div class="callout-grid" id="callout-grid"></div>
    </div>

    <hr class="section-divider" id="record-books-divider" style="display:none;">
    <div class="record-section" id="record-books-section" style="display:none;">
      <h3 class="season-subhead tgl-heading">Welcome to the Record Books</h3>
      <hr class="recap-thin-divider">
      <div id="record-books-grid" class="sentence-list"></div>
    </div>

    <hr class="section-divider">

    <div class="record-section">
      <h3 class="season-subhead tgl-heading">Standings</h3>
      <hr class="recap-thin-divider">
    ...
    <div class="record-section">
      <h3 class="season-subhead tgl-heading">Power Rankings</h3>
      <hr class="recap-thin-divider">
    ...
    <div class="record-section">
      <h3 class="season-subhead tgl-heading">Playoff Probability</h3>
      <hr class="recap-thin-divider">
...
<div class="modal-overlay" id="streakModal" aria-hidden="true">
  <div class="modal-card" role="dialog" aria-modal="true" aria-label="Streak details">
    <button class="modal-close" id="streakModalClose" aria-label="Close">&times;</button>
    <div class="modal-badge" id="streakModalBadge"></div>
...
<div class="modal-overlay" id="weekInHistoryModal" aria-hidden="true">
  <div class="modal-card" role="dialog" aria-modal="true" aria-labelledby="weekInHistoryModalBadge">
    <button class="modal-close" id="weekInHistoryModalClose" aria-label="Close">&times;</button>
    <div class="modal-badge" id="weekInHistoryModalBadge">This Week in Club History</div>
    <p class="recap-text" id="weekInHistoryModalBody"></p>
  </div>
</div>
